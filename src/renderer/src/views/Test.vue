<template>
    <div>
        ...
        <webview v-if="currentUrl" ref="webviewRef" :src="currentUrl"
            style="width: 100%; height: 800px; border: 1px solid #ccc;" @did-finish-load="onWebviewLoad" />
        <div v-if="selectedInfo" style="margin-top: 10px; border:1px solid #eee; padding:10px;">
            ...
            <div><b>xpath:</b> <span style="color:blue">{{ selectedInfo.xpath }}</span></div>
